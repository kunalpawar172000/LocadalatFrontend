...
const App = () => {
  ...
  const login = async (event) => {
    ...
    try {
      const response = await fetch("http://server-eight-nu-19.vercel.app/api/user/login", {
        method: "POST",
  ...
  const signup = async (event) => {
    ...
    try {
      const response = await fetch("http://server-eight-nu-19.vercel.app/api/user/create", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
          email: signupEmail,
  ...
  const getUsers = async () => {
    try {
      const res = await fetch("http://server-eight-nu-19.vercel.app/api/user/profile");
